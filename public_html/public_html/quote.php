...
<div class="grid_24">
    ...
    <div class="content">
        ...
        <h1><strong>Quote</strong></h1>
        <h5>Quote page is currently under development...</h5>
        <p>Design your own layout using our simple Floor Plan Grid &mdash; <a href="images/downloads/Graph%20Paper%20Layout.pdf" target="_blank"><img src="images/downloads/Graph-Paper-Layout.jpg" /></a></p>
...
<div class="grid_24">
	<div class="content">
        ...
        <form class="form-horizontal" role="form" action="contact.php" enctype="multipart/form-data" method="post" id=""> 
