...
<div class="grid_24">
  <div class="alert alert-danger">
    <h4>Sorry. This page is currently being developed. Please call
      <?php echo PHONE_MAIN; ?>
    </h4>
  </div>
  <div class="content">
      ...
      <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post" id="quote_form">
        ...
        if ($_GET['message-sent'] == "true") {
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <h5>Corian worktop colours</h5>
              <p>Please select a Corian colour.</p>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <h5>Corian worktop thickness</h5>
              <p>Please select a worktop thinkness. Please specify in message field if not listed.</p>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <p>Please select a worktop edge detail. Please specify in message field if not listed.</p>
                      ...
                      <div class="row">
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-edge-details/corian-square-edge.jpg"
                              alt="corian Square edge">Square edge
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-edge-details/corian-round-edge.jpg"
                              alt="corian Round edge">Round edge
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180"
                              src="images/corian-edge-details/corian-double-round-edge.jpg"
                              alt="corian Double round edge">Double round edge
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180"
                              src="images/corian-edge-details/corian-single-bevel-edge.jpg"
                              alt="corian Single bevel egde">Single bevel egde
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180"
                              src="images/corian-edge-details/corian-double-bevel-edge.jpg"
                              alt="corian Double bevel edge">Double bevel edge
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-edge-details/corian-ovolo-edge.jpg"
                              alt="corian Ovolo edge">Ovolo edge
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-edge-details/corian-imperial-edge.jpg"
                              alt="corian Imperial edge">Imperial edge
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-edge-details/corian-spanish-edge.jpg"
                              alt="corian Spanish edge">Spanish edge
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-edge-details/corian-waterfall-edge.jpg"
                              alt="corian Waterfall">Waterfall
                          </a>
                        </div>
                      </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <p>Please select an upstand if required. Please specify in message field if not listed.</p>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-edge-details/corian-coved-upstand.png"
                              alt="Corian coved upstand detail">Coved upstand
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-edge-details/corian-square-upstand.png"
                              alt="Corian square upstand detail">Square upstand
                          </a>
                        </div>
                      </div>
                    </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <select class="form-control">
                ...
                <option value="Corian Fontana (Specify Model in Footer of Form)">Corian Fontana (Specify Model in Footer
                  of Form)</option>
                <option value="Corian 857 &amp; 859">Corian 857 &amp; 859</option>
                <option value="No">Not Required</option>
                <option value="I will supply my own Undermount / Overmount">I will supply my own Undermount / Overmount
                </option>
              </select>
            </div>
            <div class="col-sm-6">
              ...
              <!-- Modal -->
              <div class="modal fade" id="modalCorianSinks" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-802.jpg"
                              alt="corian sink 802">802
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-804.jpg"
                              alt="corian sink 804">804
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-805.jpg"
                              alt="corian sink 805">805
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-809.jpg"
                              alt="corian sink 809">809
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-850.jpg"
                              alt="corian sink 850">850
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-857.jpg"
                              alt="corian sink 857">857
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-859.jpg"
                              alt="corian sink 859">859
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-871.jpg"
                              alt="corian sink 871">871
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-873.jpg"
                              alt="corian sink 873">873
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-881.jpg"
                              alt="corian sink 881">881
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-965.jpg"
                              alt="corian sink 965">965
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-966.jpg"
                              alt="corian sink 966">966
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-967.jpg"
                              alt="corian sink 967">967
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-969.jpg"
                              alt="corian sink 969">969
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-sinks/corian-sink-970.jpg"
                              alt="corian sink 970">970
                          </a>
                        </div>
                      </div>
                    </div>
              ...
              <!-- Modal -->
              <div class="modal fade" id="modalCorianMixaSinks" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-mixa-sinks/410M.jpg"
                              alt="corian mixa sink 410M">410M
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-mixa-sinks/809M.jpg"
                              alt="corian mixa sink 809M">809M
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-mixa-sinks/813M.jpg"
                              alt="corian mixa sink 813M">813M
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-mixa-sinks/851M.jpg"
                              alt="corian mixa sink 851M">851M
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-mixa-sinks/853M.jpg"
                              alt="corian mixa sink 853M">853M
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/corian-mixa-sinks/871M.jpg"
                              alt="corian mixa sink 871M">871M
                          </a>
                        </div>
                      </div>
                    </div>
              ...
              <!-- Modal -->
              <div class="modal fade" id="modalFontanaSinks" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <p>The sink is at the heart of every kitchen, both in terms of design and functionality. <br>
                        Our superb Fontana sinks combine DuPont&trade; &reg; with the highest quality stainless steel to
                        offer endless possibilities for the modern kitchen.</p>
                      <p>Fontana sinks are hygienic and easy to clean. The stainless steel base easily withstands boiling
                        liquid and hot pots and pans.<br>

                        Because Fontana sinks are available in all the Corian&reg; kitchen colours, the sink can be
                        integrated into a matching Corian&reg; worktop for the ultimate in contemporary kitchen style.</p>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-12R.jpg"
                              alt="Fontana sink FSP-12R">Fontana FSP-12R
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-15.jpg"
                              alt="Fontana sink FSP-15">Fontana FSP-15
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-30.jpg"
                              alt="Fontana sink FSP-30">Fontana FSP-30
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-3015.jpg"
                              alt="Fontana sink FSP-3015">Fontana FSP-3015
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-35.jpg"
                              alt="Fontana sink FSP-35">Fontana FSP-35
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-40.jpg"
                              alt="Fontana sink FSP-40">Fontana FSP-40
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-41.jpg"
                              alt="Fontana sink FSP-41">Fontana FSP-41
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-44.jpg"
                              alt="Fontana sink FSP-44">Fontana FSP-44
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-50.jpg"
                              alt="Fontana sink FSP-50">Fontana FSP-50
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-5035.jpg"
                              alt="Fontana sink FSP-5035">Fontana FSP-5035
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-851.jpg"
                              alt="Fontana sink FSP-851">Fontana FSP-851
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-851853.jpg"
                              alt="Fontana sink FSP-851853">Fontana FSP-851853
                          </a>
                        </div>
                        <div class="col-xs-6 col-md-3">
                          <a href="#" class="thumbnail">
                            <img data-src="holder.js/100%x180" src="images/fontana-sinks/FSP-853.jpg"
                              alt="Fontana sink FSP-853">Fontana FSP-853
                          </a>
                        </div>
                      </div>
                    </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <h5>Drainer Grooves</h5>
              <p>Drainer grooves can be routed directly into your worktop next to your sink and can be one side or both.
                Please enter the amount of sets you require in the box opposite.</p>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <h5>Hob Cut Outs</h5>
              <p>Number of standard hob cut outs required. For recessed hobs please specify in message box.</p>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <h5>Hob Bar Sets</h5>
              <p>Hob bars can be either routed directly into the worktop or supplied fitted into a board. Each set
                comprises of 5 bars.</p>
              <img src="images/corian-hob-bars/corian-hob-bars.jpg" alt="corian hob bar sets" width="113" height="83"
                title="Corian hob bar set">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <h5>Angled Corners</h5>
              <p>Allow for all angled corners. This would include each breakfast bar corner too.</p>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <h5>Curved Corners</h5>
              <p>Allow for all curved corners. This would include each breakfast bar corner too.</p>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <!--<h5>Curved Corners</h5>-->
              <p>Please enter the date you would like your worktop fitting.</p>
            </div>
          </div>
