<?php require ('../../../kitchen-worktops/includes/overall/includes/head.php'); ?>
...
<div class="container_24">
    ...
    <div class="grid_12">
        <div id="head-logo">
        <a href="/"><img src="../../../kitchen-worktops/images/coulsy-kitchens-logo.gif" width="442" height="39" alt="Coulsy Kitchens - fantastic designer kitchens at affordable prices" title="Coulsy Kitchens - fantastic designer kitchens at affordable prices"></a>
        </div><!--head-contact-->
    </div><!--grid_24-->
    ...
    <div class="grid_24">
        <div id="nav">
            <ul>
                ...
                <li><a href="<?php echo $nav_showrooms; ?>" <?php if ($current_page == 'about') {echo 'class="current"';} ?> >About</a></li>
